...
gambar_lokal = 'D:/New folder/Folder Kuliah Khansa Fairuz Zakiyah/KPKhansa/end2end-nlp-project-main/logo.png'
st.image(gambar_lokal)


# Utils
import joblib 
pipe_lr = joblib.load(open("D:/New folder/Folder Kuliah Khansa Fairuz Zakiyah/KPKhansa/end2end-nlp-project-main/notebooks/emotiondetector.pickle","rb"))
